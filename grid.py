...
class grid_stateful:
    ...
    def __init__(self):
        ...
        self.initialize_objects_method = None


    # The Initialize Event
    def initialize(self):

        self.initialize_method = self.level.__init__
        self.begin_method = self.level.begin
        self.press_tile_method = self.level.press_tile
        self.press_button_method = self.level.press_button
        self.initialize_objects_method = self.level.initialize_objects
        ...
        # Preload all the objects and how many colors they will use
        self.initialize_objects_method(self.current_state)
...
try:
    ...
    from grid_methods.objects import add_objects, find_object, find_all
    ...
    from objects import add_objects, find_object, find_all
...
grid_stateful.add_objects = add_objects
grid_stateful.find_object = find_object
grid_stateful.find_all = find_all
